...
<nav class="navbar navbar-inverse">
 ...
 <div id="top" class="row">
    ...
    <div class="col-md-3">
        <a href="add-bol.html" class="btn btn-primary pull-right h2">Novo boleto</a>
    </div>
</div> <!-- /#top -->
        ...
        <table class="table table-striped" cellspacing="0" cellpadding="0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>1000,00</td>
                    <td class="actions">
                        <a class="btn btn-success btn-xs" href="view-bol.html">Visualizar</a>
                        <a class="btn btn-warning btn-xs" href="edit-bol.html">Editar</a>
