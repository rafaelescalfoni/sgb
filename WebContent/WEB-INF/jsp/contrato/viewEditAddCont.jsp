...
<nav class="navbar navbar-inverse">
 ...
 <div id="top" class="row">
    ...
    <div class="col-md-3">
        <a href="add-cont.html" class="btn btn-primary pull-right h2">Novo Contrato</a>
    </div>
</div> <!-- /#top -->
        ...
        <table class="table table-striped" cellspacing="0" cellpadding="0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>Sim</td>
                    <td class="actions">
                        <a class="btn btn-success btn-xs" href="view-cont.html">Visualizar</a>
                        <a class="btn btn-warning btn-xs" href="edit-cont.html">Editar</a>
